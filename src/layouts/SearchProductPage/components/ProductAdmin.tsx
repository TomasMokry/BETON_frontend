      ...
      <div className="card-body">
        <div className="admin-card-header">
          <div className="admin-card-info">
            ...
            <p className="card-text mb-0">{productInfo}</p>
          </div>

          <div className="admin-card-actions">
            <span className="qty-chip">{props.product.amount} ks</span>
            ...
            <button
              type="button"
              className={`btn-icon${expanded ? " is-active" : ""}`}
              title="Product detail"
              aria-label={expanded ? "Hide product detail" : "Show product detail"}
